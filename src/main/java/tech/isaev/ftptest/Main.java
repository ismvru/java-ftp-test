...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Get values - required
        String ftpServer = cmd.getOptionValue("server");
        String ftpUser = cmd.getOptionValue("user");
        ...
        // Main app work
        logger.info("Connect as " + ftpUser + " to " + ftpServer + ":" + ftpPort + " FTP(s) and to " + ftpServer + ":" + sftpPort + " SFTP");
